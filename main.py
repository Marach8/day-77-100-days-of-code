...
def story1():
  ...
  date = '17-05-2023'
  text = '''I went to Enugu yesterday to check my laptop baterry and all the man could do is to tell me that the battery he gave me initially had a seal on it while the one I am returning has no seal on it and therefore, there is nothing he can do about it. I nearly ran mad sha
  '''
  page1 = ''
